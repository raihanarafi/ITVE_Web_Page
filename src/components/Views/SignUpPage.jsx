        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-10 flex flex-col justify-center bg-blue-600/5 border-r border-slate-800/50">
            ...
            <p className="mt-4 text-slate-400 text-sm font-medium max-w-[250px]">
              Start your journey with us and master new technical skills today.
            </p>
            <div className="mt-8 flex items-center gap-2">
              <div className="h-1 w-12 bg-blue-600 rounded-full"></div>
              <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest">Create an account</span>
            </div>
          </div>
          ...
          <div className="p-8 md:p-12">
            <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
              ...
              {/* Sign Up Button */}
              <button className="w-full bg-blue-600 text-white h-12 rounded-xl font-bold hover:bg-blue-500 transition-all shadow-md mt-2">
                Create Account
              </button>
